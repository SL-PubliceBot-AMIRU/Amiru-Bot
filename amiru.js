...
// Sql
const AmirubotDB = Raviya.DATABASE.define('AmirubotWhatsappBot', {
    info: {
                        ...
                        try {
                            ...
                            if (Raviya.LANG == 'SI') {
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ දෝෂ විශ්ලේෂණය [AMIRU BOT] 🧟‍♀️*' + 
                                        '\n========== ```දෝෂ නිරාකරණය කර ඇත!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ ERROR ANALYSIS [AMIRU BOT] 🧟‍♀️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
