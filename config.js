...
module.exports = {
    ...
    SESSION: process.env._Amiru_Bot_SESSION === undefined ? '' : process.env._Amiru_Bot_SESSION,
    ...
    DATABASE: DATABASE_URL === './amirubot.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
